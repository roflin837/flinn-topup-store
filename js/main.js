...
function renderNominals(productName) {
    const list = productName.includes("Pulsa") || productName.includes("Indosat") 
...
function selectNominal(el, name, price) {
    document.querySelectorAll(".nominal-btn").forEach(btn => btn.classList.remove("ring-2", "ring-primary", "bg-indigo-50"));
...
async function processCheckout() {
    ...
    try {
        ...
        if (result.statusCode === "00") {
            ...
            alert("Error Duitku: " + result.statusMessage);
        }
    } catch (e) {
...
function showHistory() {
    ...
    mainContent.innerHTML = `
        <div class="container mx-auto px-4 py-8">
            ...
            <div class="bg-white dark:bg-darkCard rounded-[2rem] shadow-xl overflow-hidden">
